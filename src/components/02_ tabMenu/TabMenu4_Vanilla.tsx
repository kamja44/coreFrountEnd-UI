...
const buildTabDescription = ({ id, description }: TabItem, index: number) => {
...
const initiator = (wrapper: HTMLDivElement) => {
  ...
  const $descriptions = data.map(buildTabDescription);
...
const TabMenu4_Vanilla = () => {
  return <VanillaWrapper title="#4" initiator={initiator} />;
};

export default TabMenu4_Vanilla;
